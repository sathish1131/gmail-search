...
public class EmailService{
   ...
   * Application name.
   */
  private static final String APPLICATION_NAME = "Gmail API Search";
  /**
  ...
  private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
      throws IOException {
    // Load client secrets.
    InputStream in = null;//GmailQuickstart.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
    if (in == null) {
  ...
  public List<Message> searchEmails(String query) throws IOException, GeneralSecurityException {
  ...
  private Gmail initialiseGmailService() throws IOException,GeneralSecurityException {
